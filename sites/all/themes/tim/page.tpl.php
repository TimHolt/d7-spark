...
<div id='page'><div id='main-content' class='limiter clearfix'>
  ...
  <div id='left-sidebar' class='page-left-sidebar clearfix'>
  	<?php if (!empty($page['left_sidebar'])) print render($page['left_sidebar']) ?>
  </div>
  <div id='content' class='page-content clearfix'>
    <?php if (!empty($page['content'])) print render($page['content']) ?>
  </div>
  <div id='right-sidebar' class='page-right-sidebar clearfix'>
  	<?php if (!empty($page['right_sidebar'])) print render($page['right_sidebar']) ?>
  </div>
</div></div>
